 ...
 * @param USE_Q
 * @text 制御文字Q使用
 * @desc 制御文字Qを使用可能にし、文字列をjsonファイル（msg_99）から取得します。
 * @default false
 * @type boolean
 * @parent fileSection
 * 
...
または、制御文字 LANG & LANGEND および Q を使います。
...
：　　：\Q[battle_1_01]テストです。/LANGFEND
◆文章：\N[2], Actor1(1), ウィンドウ, 下
：　　：\Q[battle_1_02]これがバトルです。/LANGFEND
...
- ver.3.2.2 (2022/07/15) 制御文字 Q を修正
...
- ver.4.1.0 (2023/07/06) 制御文字 Q の仕様変更
