...
(function() {
  ...
  s = [['controlType', ['WHEEL', 'TOUCH', 'LEAP MOTION CONTROLLER', 'GAMEPAD', 'KEYBOARD'], 0, 0, 'Controls: '], ['quality', ['LOW', 'MID', 'HIGH', 'VERY HIGH'], 3, 3, 'Quality: '], ['hud', ['OFF', 'ON'], 1, 1, 'HUD: '], ['godmode', ['OFF', 'ON'], 0, 1, 'Godmode: ']];
